...
import { validateConfig as sharedValidateConfig, validateAndApplyDefaults } from '../shared-config/config-validator';
...
/**
 * Validate configuration object using shared validation
 * @param config Configuration to validate
 * @throws Error if configuration is invalid
 */
export function validateConfig(config: DtoGeneratorConfig): void {
  sharedValidateConfig(config);
}